...
if len(Config.sections()) == 0:
    ...
    sys.exit(0)
PATH_IN = Config.get('TIMESTAMP', 'PATH_IN')
PATH_OUT = Config.get('TIMESTAMP', 'PATH_OUT')
TIMEZONE = Config.get('TIMESTAMP', 'TIMEZONE')
CITY_NAME = Config.get('TIMESTAMP', 'CITY_NAME')
